...
Route::middleware('auth:sanctum')->group(function () {
    Route::prefix('/auth')->group(function () {
        ...
        Route::post('/google/calendar/proxy', [GoogleCalendarController::class, 'proxy']);
        Route::post('/google/meet/create', [GoogleMeetController::class, 'create']);
